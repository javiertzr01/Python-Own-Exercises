...
if __name__ == "__main__":
    ...
    englishwords = QtCore.QFile(":/csv/englishwords.csv")
    if englishwords.open(QtCore.QIODevice.ReadOnly):
        f = io.BytesIO(englishwords.readAll().data())
    file = pd.read_csv(f, sep = ';', skiprows=3)
